/*
 * This is a rectangle mesh in a x-t plane (space-time plane) with 
 * with spacing h along the x direstion and k along the t direction. 
 * 
 * e.g. point (x,t) is denoted as (ih, jk). 
 *
 * The output is a rectangular mesh
 */ 
